...
históricos IS_FOOD, IS_CHEMICAL, IS_CHILLED e IS_FROZEN. La migración 007
...
POST /api/item-families usa códigos del catálogo en attributes. La familia y sus
vínculos se guardan en una transacción; el repositorio resuelve los códigos a UUID
solo para persistir los vínculos y revalida las referencias.
